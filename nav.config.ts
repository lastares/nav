...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/lastares/nav',
  ...
  // 网站描述
  description: '灵晨导航 - 精选实用导航网站',

  // 网站关键字
  keywords: '灵晨导航,前端资源,社区站点,设计师,实用工具,学习资源,运营,网络安全,node.js',
  ...
  footerContent: `
    ...
    <div>Copyright © 2018-2021 <a href="https://songyaofeng.com" target="_blank" style="color: inherit;">灵晨的BLOG </a><span style="color: #e27575;font-size: 14px;">❤</span><span> &nbsp;&nbsp;ICP备案：<a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank">浙ICP备18002648号-1</a></span>, All Rights Reserved</div>
  `,
